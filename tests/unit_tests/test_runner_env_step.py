...
``RecordVideo.set_global_step`` ties each media row to a point on the metric
curves. These tests inspect call sites because running the driver loops requires
a live Ray cluster.
"""
