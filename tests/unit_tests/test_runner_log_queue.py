...
``EmbodiedRunner`` hands metric logging to a background thread and waits for the
queue to drain before terminal state. Teardown must handle both failure modes:
