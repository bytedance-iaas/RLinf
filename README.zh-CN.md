...
- [2026/08] 🔥 RLinf 支持 SO101（SO-ARM101）机械臂的 real2sim 强化学习：依实测几何在 ManiSkill 中重建真实抓取摆放工作台，并用 π₀.₅ 做强化学习微调。文档：[SO101（Real2Sim）](https://rlinf.readthedocs.io/zh-cn/latest/rst_source/examples/embodied/so101.html)。
