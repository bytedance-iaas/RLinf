  ...
  return (
    <>
      ...
      <div className="cards">
        ...
        {/* 8. Anomalies -- the metric-side signals, kept visibly separate from the
             server verdict in card 6. These are the three the criterion names and
             the server cannot compute: they need the series, and `derive_health` is
             a pure function of a snapshot and a clock by design. */}
        <Card
          label="Anomalies"
          adornment={
