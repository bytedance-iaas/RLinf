...
timeout 7200 .venv/bin/python tools_so101_session/gen_planner_demos.py --num 12 --seed0 79000 \
...
timeout 14400 .venv/bin/python tools_so101_session/convert_fullboard.py > "$SCRATCH/convert_v4.out" 2>&1
