...
SRC = "/data08/henryg/pai/data/so101_pp5_rollouts"
OUT_REPO = "so101-sim-demos-pp5"
OUT_ROOT = "/data08/henryg/pai/data/so101-sim-demos-pp5"
TASK = "Grab the red cube"
FPS = 15
MIN_LEN, MAX_LEN = 30, 220  # sanity bounds (success episodes; 240 budget)

files = sorted(glob.glob(SRC + "/*.npz"))
